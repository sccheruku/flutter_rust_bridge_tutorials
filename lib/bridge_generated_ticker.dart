...
class TickerApiImpl extends FlutterRustBridgeBase<TickerApiWire>
    implements TickerApi {
  factory TickerApiImpl(ffi.DynamicLibrary dylib) =>
      TickerApiImpl.raw(TickerApiWire(dylib));

  TickerApiImpl.raw(TickerApiWire inner) : super(inner);
...
/// generated by flutter_rust_bridge
class TickerApiWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  TickerApiWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  TickerApiWire.fromLookup(
