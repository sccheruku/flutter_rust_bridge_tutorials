...
abstract class RepoInfoApi {
  Future<RepoInfo> getRepoInfo({required String repoName, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kGetRepoInfoConstMeta;
}
...
class RepoInfoApiImpl extends FlutterRustBridgeBase<RepoInfoApiWire>
    implements RepoInfoApi {
  factory RepoInfoApiImpl(ffi.DynamicLibrary dylib) =>
      RepoInfoApiImpl.raw(RepoInfoApiWire(dylib));

  RepoInfoApiImpl.raw(RepoInfoApiWire inner) : super(inner);
  ...
  Future<RepoInfo> getRepoInfo({required String repoName, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        ...
        constMeta: kGetRepoInfoConstMeta,
        argValues: [repoName],
        hint: hint,
      ));
...
/// generated by flutter_rust_bridge
class RepoInfoApiWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  RepoInfoApiWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RepoInfoApiWire.fromLookup(
